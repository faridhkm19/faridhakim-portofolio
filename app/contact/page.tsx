            ...
            <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-card)] p-5">
              ...
              <div className="pb-5">
                ...
                <a
                  ...
                  className="font-medium text-[var(--color-orange-accent)] underline-orange hover:text-[var(--color-orange-accent-dark)] transition-colors"
                >
                  {personalInfo.email}
                </a>
              </div>
          ...
          <Reveal direction="left" className="lg:col-span-3">
            {formState === "success" ? (
              <motion.div
                ...
                className="flex h-full min-h-80 flex-col items-center justify-center rounded-2xl border border-[var(--color-orange-accent)]/30 bg-[var(--color-bg-card)] p-10 text-center"
              >
              ...
              >
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      Full Name <span className="text-[var(--color-orange-accent)]">*</span>
                    </label>
                    <input
                      id="contact-name"
                      name="name"
                  ...
                  <div className="space-y-1.5">
                    <label
                      ...
                      className="text-sm font-medium text-[var(--color-fg)]"
                    >
                      Email Address <span className="text-[var(--color-orange-accent)]">*</span>
                    </label>
                    <input
                      id="contact-email"
                      name="email"
                ...
                <div className="space-y-1.5">
                  <label
                    ...
                    className="text-sm font-medium text-[var(--color-fg)]"
                  >
                    Subject <span className="text-[var(--color-orange-accent)]">*</span>
                  </label>
                  <select
                    id="contact-subject"
                    name="subject"
                ...
                <div className="space-y-1.5">
                  <label
                    ...
                    className="text-sm font-medium text-[var(--color-fg)]"
                  >
                    Message <span className="text-[var(--color-orange-accent)]">*</span>
                  </label>
                  <textarea
                    id="contact-message"
                    name="message"
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full rounded-full bg-[var(--color-orange-accent)] py-3.5 font-heading text-sm font-semibold text-white transition-all duration-300 disabled:opacity-60 hover:shadow-[0_0_24px_color-mix(in_srgb,var(--color-orange-accent)_40%,transparent)] hover:bg-[var(--color-orange-accent-dark)]"
                >
